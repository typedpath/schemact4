...
class MultiPartOld(headers: String, val body: ByteArray) {
    ...
    companion object {
        fun read(body: String, contentType: String): Map<String, MultiPartOld> {
