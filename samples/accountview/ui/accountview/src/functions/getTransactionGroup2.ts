...
export default async function getTransactionGroup2(fromInclusiveDate_in: string, toInclusiveDate_in: string, accountNumber_in: string, Authorization_in: string) : Promise<AxiosResponse<TransactionGroup, any>> { // TODO map to specified return type
    let url = urlPath
