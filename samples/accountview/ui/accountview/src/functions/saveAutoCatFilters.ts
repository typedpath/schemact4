...
export default async function saveAutoCatFilters(Authorization_in: string, autoCatFilters_in: AutoCatFilter[]) : Promise<AxiosResponse<UserInfo, any>> { // TODO map to specified return type
    let url = urlPath
