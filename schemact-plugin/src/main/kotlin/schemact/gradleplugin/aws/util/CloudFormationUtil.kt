...
object CloudFormationUtil {
    ...
    fun getStack(
        ...
        stackbuilder: AmazonCloudFormation
    ): Stack? {
        ...
        while (completeStack == null) {
            ...
            val stackStatus =
                if (theStacks != null && theStacks.size > 0) theStacks.get(0).stackStatus.toUpperCase() else "unknown"
    ...
    private fun requestCreateStack(
        stackName: String,
        strTemplate: String,
    ...
    private fun requestUpdateStackAcceptNoChange(
        stackName: String,
        templateBody: String?,
        templateUrl: String?,
        ...
        try {
            ...
            if (ex.message != null && ex.message!!.toLowerCase()
    ...
    fun defaultCurrentDateTimePattern() =
        "${
            (DateTimeFormatter.ofPattern("ddMMMyy-HHmmss")).format(LocalDateTime.now())
                .toLowerCase()
        }"
