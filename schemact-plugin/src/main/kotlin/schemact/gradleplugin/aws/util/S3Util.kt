...
fun copyToS3(bucketName: String, bucketFolder: String, distributionDirectory: String, region: Regions = Regions.US_EAST_1) =
         copyToS3(bucketName, bucketFolder, File(distributionDirectory), region)

fun copyToS3(bucketName: String, bucketFolder: String, distributionDirectory: File, region: Regions = Regions.US_EAST_1) {
